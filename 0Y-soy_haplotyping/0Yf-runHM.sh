...
generic_runHM.sh -i ../input/indep1000_5_0.8_nohet_prefin_impu_bial_16_SNP_id_filt_all.hmp.txt -k ../nohet_fin_impu_bial_16_SNP_id_filt_all_kinship_HMformatted.txt -s ../impu_bial_16_SNP_id_filt_all.vcf.10.meanQ_HMformatted.txt -gdb ../input/my_gene_db.txt -cdb ../input/chr16_size.txt -r 50000 -m 0.9 -c 0.6 -n Gm16_301_302_C0.6
