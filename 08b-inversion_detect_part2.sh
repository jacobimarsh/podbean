...
nucmer -c 100 -p lupal9_lupal10 lupal9.fa lupal10.fa; mummerplot -p lupal9_lupal10 --png lupal9_lupal10.delta; sed -i 's/ png.*/ pngcairo/' lupal9_lupal10.gp;	sed -i '/set mouse clipboardformat/d' lupal9_lupal10.gp; gnuplot lupal9_lupal10.gp
nucmer -c 100 -p lupal10_medtr11 lupal10.fa medtr11.fa; mummerplot -p lupal10_medtr11 --png lupal10_medtr11.delta; sed -i 's/ png.*/ pngcairo/' lupal10_medtr11.gp; sed -i '/set mouse clipboardformat/d' lupal10_medtr11.gp; gnuplot lupal10_medtr11.gp
